...
import 'schema/situacoes_record.dart';
...
export 'schema/situacoes_record.dart';
...
/// Functions to query SituacoesRecords (as a Stream and as a Future).
Future<int> querySituacoesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      SituacoesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<SituacoesRecord>> querySituacoesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      SituacoesRecord.collection,
      SituacoesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<SituacoesRecord>> querySituacoesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<int> queryParcelasRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ParcelasRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );
...
Future<int> queryFormaPagamentoRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      FormaPagamentoRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );
