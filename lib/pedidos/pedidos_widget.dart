...
import '/pages/empty_orcamento/empty_orcamento_widget.dart';
    ...
    return AuthUserStreamWidget(
      builder: (context) => StreamBuilder<List<PedidosRecord>>(
        ...
        builder: (context, snapshot) {
          ...
          List<PedidosRecord> pedidosPedidosRecordList = snapshot.data!;
          ...
          return GestureDetector(
            ...
            child: Scaffold(
              ...
              floatingActionButton: FloatingActionButton(
                onPressed: () async {
                  context.pushNamed('clientesCadastradosPedido');
                },
                                    ...
                                    child: Builder(
                                      builder: (context) {
                                        ...
                                        return ListView.builder(
                                          ...
                                          itemBuilder:
                                              (context, orcamentosIndex) {
                                            final orcamentosItem =
                                                orcamentos[orcamentosIndex];
                                            return Visibility(
                                              visible:
                                                  functions.pesquisa2campos(
                                                          _model.textController
                                                              .text,
                                                          orcamentosItem
                                                              .razaoSocial,
                                                            ...
                                                            children: [
                                                              ...
                                                              Expanded(
                                                                child: Row(
                                                                  ...
                                                                  children: [
                                                                    Text(
                                                                      'Orçamento #${orcamentosItem.numeroPedido.toString()}',
                              ...
                              Column(
                                ...
                                children: [
                                  Expanded(
                                    child: Builder(
                                      builder: (context) {
                                        final pedidos = pedidosPedidosRecordList
                                            .where((e) =>
                                                          ...
                                                          children: [
                                                            ...
                                                            Expanded(
                                                              child: Row(
                                                                ...
                                                                children: [
                                                                  Text(
                                                                    'Pedido #${pedidosItem.numeroPedido.toString()}',
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodyLarge
                                                                        .override(
