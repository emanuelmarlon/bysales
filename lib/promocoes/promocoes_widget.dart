    ...
    return AuthUserStreamWidget(
      builder: (context) => StreamBuilder<List<UsersRecord>>(
        ...
        builder: (context, snapshot) {
          ...
          List<UsersRecord> promocoesUsersRecordList = snapshot.data!;
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        '8749ej87' /* Digite o título da notificação... */,
                                      ),
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        'fk7ma3oh' /* digite a descrição da notifica... */,
                                      ),
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        if (_model.textController1.text == '') {
                          ...
                          if (_model.listaUsuarios.isEmpty) {
                            await showDialog(
                              context: context,
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  title: const Text('By.Sales'),
                                  content: const Text('Nenhum usuário selecionado.'),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
                                          Navigator.pop(alertDialogContext),
                            ...
                            triggerPushNotification(
                              ...
                              notificationImageUrl: widget.produto?.imagem,
                              notificationSound: 'default',
                              userRefs: _model.listaUsuarios.toList(),
                            ...
                            unawaited(
                              () async {
                                await widget.produto!.reference
                                  ...
                                  promocao: true,
                                  tituloPromocao: _model.textController1.text,
                                  descricaoPromocao:
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Builder(
                                builder: (context) {
                                  final usuarios =
                                      promocoesUsersRecordList.toList();
                                                        ...
                                                        onChanged:
                                                          ...
                                                          safeSetState(() =>
                                                              _model.checkboxValueMap[
                                                                  ...
                                                                  newValue!);
                                                          if (newValue!) {
                                                            _model.addToListaUsuarios(
                                                                usuariosItem
                                                                    .reference);
                                                            safeSetState(() {});
                                                          } else {
                                                            _model.removeFromListaUsuarios(
                                                                usuariosItem
                                                                    .reference);
                                                            safeSetState(() {});
                                                          }
