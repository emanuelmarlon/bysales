...
import 'clientes_cadastrados_model.dart';
export 'clientes_cadastrados_model.dart';

class ClientesCadastradosWidget extends StatefulWidget {
  const ClientesCadastradosWidget({super.key});

  @override
  State<ClientesCadastradosWidget> createState() =>
      _ClientesCadastradosWidgetState();
}

class _ClientesCadastradosWidgetState extends State<ClientesCadastradosWidget>
    with TickerProviderStateMixin {
  late ClientesCadastradosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClientesCadastradosModel());
                  ...
                  child: StreamBuilder<List<ClientesRecord>>(
                    stream: queryClientesRecord(
                      queryBuilder: (clientesRecord) =>
                          clientesRecord.orderBy('razaoSocial'),
                    ),
                                ...
                                onTap: () async {
                                  context.pushNamed(
                                    ...
                                    extra: <String, dynamic>{
                                      'clienteDoc': listViewClientesRecord,
                                    },
                                  );
                                },
                                onDoubleTap: () async {
                                  if (valueOrDefault<bool>(
                                        ...
                                        await showDialog<bool>(
                                              ...
                                              builder: (alertDialogContext) {
                                                return AlertDialog(
                                                  ...
                                                  content: const Text(
                                                      'Deseja excluir definitivamente este cliente?'),
                                                  actions: [
                                                    TextButton(
                                                      onPressed: () =>
                                                          Navigator.pop(
                                    ...
                                    if (confirmDialogResponse) {
                                      await listViewClientesRecord.reference
                                          .delete();
                                    }
                                  }
                                },
